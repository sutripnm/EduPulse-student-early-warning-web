    ...
    <section className="row g-3 mb-4">
      ...
      <div className="col-6 col-xl-3">
        <div className="dashboard-kpi h-100 p-3">
          <div className="d-flex justify-content-between align-items-start">
            <div>
              <p className="text-secondary mb-1">Total Siswa</p>
      ...
      <div className="col-6 col-xl-3">
        <div className="dashboard-kpi h-100 p-3">
          <div className="d-flex justify-content-between align-items-start">
            <div>
              <p className="text-secondary mb-1">Risiko Tinggi</p>
      ...
      <div className="col-6 col-xl-3">
        <div className="dashboard-kpi h-100 p-3">
          <div className="d-flex justify-content-between align-items-start">
            <div>
              <p className="text-secondary mb-1">Risiko Sedang</p>
      ...
      <div className="col-6 col-xl-3">
        <div className="dashboard-kpi h-100 p-3">
          <div className="d-flex justify-content-between align-items-start">
            <div>
              <p className="text-secondary mb-1">Risiko Rendah</p>
              <h3 className="fw-bold mb-1 text-success">
                {dashboardData ? dashboardData.proporsi_risiko.rendah.count : "..."}
              </h3>
